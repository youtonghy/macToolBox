...
9. **设置窗口** — “首页 / 线缆 / Wi-Fi / 显示器 / 音频 / 快捷键 / 通用”；快捷键页已提供区域截图的预留入口，可启停、自定义全局组合键并恢复默认值；实际截图动作尚未接入。显示器页提供聚焦模式开关和 20%–85% 变暗强度，音频页提供精确百分比滑杆、恢复 100% 和输出设备选择。
...
- **区域截图**：当前版本仅完成统一快捷键规则、持久化、Carbon 注册与设置界面；触发区域截图快捷键只进入预留回调，尚不会创建截图。
